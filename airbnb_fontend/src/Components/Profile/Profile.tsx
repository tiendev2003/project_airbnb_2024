...
import { ACCESS_USER_ID, BASE_URL, IBookRoom, IProfile, PAGE_SIZE } from "../../constant/constant"
    ...
    const handleUpdateAva =async ()=>{
        try{
            ...
            if(file !== null){
                ...
                await axiosInterceptor.put(`api/users/change-avatar/${getLocal(ACCESS_USER_ID)}`, formFile)
            }
                ...
                <div className="profile-section col-lg-3">
                    <div className="profile-fixed">
                        <div className="profile-avatar">
                            <img src={!profileData?.avatar ? "/src/assets/Image/emptyAva.jpg" :BASE_URL+"/"+ profileData?.avatar} alt="" />
