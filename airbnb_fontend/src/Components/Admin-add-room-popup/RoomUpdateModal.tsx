...
import { BASE_URL, IRoomDetail } from '../../constant/constant';
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values: IRoomDetail) => {
            try {
                ...
                await axiosInterceptor.put(`/api/phong-thue/${roomdata.id}`, formData, {
                    headers: {
                ...
                swal(`Thành công cập nhật phòng ${newValue}`, { icon: "success" })
                handleCloseUpdate()
            } catch (error) {
                console.log(error)
            ...
            <form action="" onSubmit={formik.handleSubmit}>
                <Grid container spacing={2} className='mui-grid-container-room'>
                    ...
                    <Grid item lg={4} className='mui-grid-item-room'>
                        ...
                        <img className="mb-2" src={preview ? preview : BASE_URL + "/" + formik.values.hinhAnh} alt="" style={{ height: "5rem", display: "block" }} />
