...
//const
import { BASE_URL, ILocationItem } from '../../constant/constant';
//services
...
function ManageLocation() {
    ...
    const columns: GridColDef[] = [
        ...
        { field: 'tenViTri', headerName: 'Tên vị trí', width: 200, align: 'center', headerAlign: 'center' },
        {
            ...
            renderCell: (params) => { return <Avatar alt="Remy Sharp" src={BASE_URL + "/" + params.row.hinhAnh} /> }
        },
        {
            field: 'tinhThanh',
    ...
    let newRows = dataRetrieve.data ? dataRetrieve.data : rows
    console.log(newRows)
    React.useEffect(() => {
